...
import 'package:firebasesetupex/addpage.dart';
...
class _HomePageState extends State<HomePage>
{
          ...
          (
            ...
            builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot)
            {
              ...
              snapshot.data?.docs.map((DocumentSnapshot documentSnapshot)
              {
                ...
                return Scaffold
                  (
                    appBar: AppBar( title: Text('Crud Operation'.toUpperCase()),),
                    body: Container
                      (
  ...
  Future<void> deletedata(firebaseData)
  {
    return delUser.doc(firebaseData)
        .delete()
