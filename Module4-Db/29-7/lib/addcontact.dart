...
import 'package:sqfliteex2/dbhelper.dart';
...
class _AddContactState extends State<AddContact>
{
  ...
  void insertcontact()
  {
    ...
    if(imageFile!.exists()!=null)
    {
      ...
      {
        MyDbHelper.columnName: name.text.toString(),
        MyDbHelper.columnLName: lname.text.toString(),
        MyDbHelper.columnMobile: mobile.text.toString(),
        MyDbHelper.columnEmail: email.text.toString(),
        MyDbHelper.columnCategory: currentCategory,
        MyDbHelper.columnProfile:base64image,
      };

      dbHelper.insertdata2(row);
      print("Inserted2");
    }
